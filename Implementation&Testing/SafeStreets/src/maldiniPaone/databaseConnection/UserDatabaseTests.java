...
public class UserDatabaseTests {
	...
	public static String[] citizenNames = { "angelo", "pietro", "luca", "matteo", "antonio", "calogero", "carciofo" };
	public static String[] authorityNames = { "aldo", "annibale", "distruttore", "calzolaio", "alberigo", "ermenegildo",
			"caldo" };
	public static String[] managerNames = { "a", "b", "c", "d", "e", "f", "h" };
	public static String[] municipalityNames = { "i", "l", "m", "n", "o", "p", "q" };
	public static String[] retriedNames = citizenNames;// reuse citizen names and try to add new user with those
														// usernames
	public static String[] passwords = { "a", "p", "l", "m", "a", "c", "c" };
	public static String[] emailsCitizen = { "a@n", "p@i", "l@u", "m@a", "a@nt", "c@a", "c@ar" };
	public static String[] emailsMunicipality = { "a", "b", "c", "d", "e", "f", "g" };
	public static String[] emailsManager = { "h", "i", "l", "m", "n", "o", "p" };
	public static String[] emailsAuthoryties = { "q", "r", "s", "t", "u", "v", "w" };
	public static String[] venues = { "lombaria" };
	public static String[] cityHallsNames = { "alserio", "erba", "anzano" };
	public static String[] cityHallsProvinces = { "como", "lecco", "sondrio" };
