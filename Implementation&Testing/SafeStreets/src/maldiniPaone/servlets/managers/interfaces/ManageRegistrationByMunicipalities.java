...
/**
 * This interface defines the signatures of the methods to manage registrations
...
public interface ManageRegistrationByMunicipalities {
	 ...
	 * @param creator          : the username of the municipality creating the other
	 *                         municipality
	...
	public boolean registerMunicipalityByMunicipality(String username, String password, String email, String creator,
			String cityHallName, String cityHallProvince) throws ServerSideDatabaseException, IllegalParameterException;
	 ...
	 * @param creator                  : the username of the municipality creating
	 *                                 the authority
	 * @param cityHallName             : the name of the city hall of the creator
	 * @param cityHallProvince         : the province of the city hall of the
	 *                                 creator
	 * @param topLeftDistrictBound     : the coordinates of the top left bound of
	 *                                 the district where the authority works
	 * @param bottomRightDistrictBound : the coordinates of the bottom right bound
	 *                                 of the district where the authority works
	 * @return true if the creation is successful false otherwise
	 * @throws ServerSideDatabaseException when the database can't be found
	 * @throws IllegalParameterException   when parameters are not valid(empty or
	 *                                     null)
